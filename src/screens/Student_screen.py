...
from src.pipelines.voice_pipelline import get_voice_embedding
...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button(key_suffix=None):
...
def Student_screen():
    ...
    if st.session_state.show_registration and st.session_state.photo_source:
        with st.container(border=True):
            st.header('Register new Profile')
            new_name = st.text_input("Enter your name", placeholder="E.g Sanket Dongardive")
            ...
            audio_data = None
            try:
                audio_data = st.audio_input('Record a short phrase like: I am present, My name is Sanket.')
            except Exception:
